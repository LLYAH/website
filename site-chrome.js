...
(function () {
  ...
  class SiteFooter extends HTMLElement {
    connectedCallback() {
      ...
      this.innerHTML =
        '<footer style="background:linear-gradient(160deg,#302D2A 0%,#1A1917 55%,#0D0C0B 100%);color:#EDEAE4;padding:54px 34px 28px;font-family:\'Hanken Grotesk\',sans-serif">' +
          '<div style="max-width:1080px;margin:0 auto;display:flex;flex-wrap:wrap;gap:40px;justify-content:space-between">' +
            ...
            '<div style="display:flex;flex-wrap:wrap;gap:48px">' +
              '<div style="display:grid;grid-template-columns:repeat(3,minmax(100px,auto));gap:10px 28px;align-content:start"><div style="grid-column:1/-1;font-size:12px;font-weight:800;letter-spacing:1.2px;text-transform:uppercase;color:#8a847c;margin-bottom:2px">Shop</div>' +
                link("t-shirts.html", "Shirts") + link("hoodies.html", "Hoodies") + link("jewelry.html", "Jewelry") + link("posters.html", "Posters") +
                link("hats.html", "Hats") + link("mugs.html", "Mugs") + link("paintings.html", "Art") + link("stickers.html", "Stickers") + link("magnets.html", "Magnet") +
                link("cups.html", "Drinkware") + link("tumblers.html", "Water Bottles") + link("woodworking.html", "Woodwork") + link("glasswork.html", "Glassworks") + "</div>" +
              '<div style="display:grid;grid-template-columns:repeat(2,minmax(100px,auto));gap:10px 28px;align-content:start"><div style="grid-column:1/-1;font-size:12px;font-weight:800;letter-spacing:1.2px;text-transform:uppercase;color:#8a847c;margin-bottom:2px">Support and Community</div>' +
                link("give-back.html", "Give Back") + link("donate.html", "Donate") + link("contact.html", "Contact") +
                link("testimonies.html", "Testimonies") + link("radio.html", "Live Radio") + link("prayer.html", "Prayer Requests") + link("daily-verse.html", "Daily Bible Verse") + link("prophetic-word.html", "Prophetic Words") + link("devotional.html", "Daily Devotional") + link("affirmations.html", "Affirmations") + link("scripture-resources.html", "Bible Verses") + link("inspirational-graphics.html", "Inspirational Posts") + "</div>" +
            "</div>" +
          "</div>" +
          '<div style="max-width:1080px;margin:34px auto 0;padding-top:20px;border-top:1px solid rgba(255,255,255,.12);display:flex;flex-wrap:wrap;gap:12px;justify-content:space-between;font-size:12px;color:#8a847c">' +
            "<span>© 2026 Love &amp; Love YAH. All rights reserved. <a class=\"plain\" href=\"https://crosstownseo.com\" target=\"_blank\" rel=\"noopener\" style=\"color:#a49f97;text-decoration:underline\">Website design by CROSSTOWN SEO</a></span>" +
